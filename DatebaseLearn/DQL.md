...
- 应用
- 语法格式
  ![image-20240102140552037](photo\image-20240102140552037.png)
- 简化版语法
  ![image-20240102140614905](photo\image-20240102140614905.png)
- 数据准备
...
- 运算符
  ...
  - 简介
    ...
    - 算数运算符
      ![image-20240102160042794](photo\image-20240102160042794.png)
    - 比较运算符
      ![image-20240102160238215](photo\image-20240102160238215.png)
    - 逻辑运算符
      ![image-20240102160312457](photo\image-20240102160312457.png)
    - 位运算符
      ![image-20240102160338053](photo\image-20240102160338053.png)位运算是在二进制数上进行计算的运算符。位运算会先将操作数变成二进制数，进行位运算。然后再将计算结果从二进制数变回十进制数。
